...
### 2. [stovol: An R package on Bayesian Markov Chain Monte Carlo inference for stochastic volatility models](https://github.com/zhongxianmen2020/stovol/stovol.html) 
...
### 3. [stoconl: An R package on Bayesian Markov Chain Monte Carlo inference for stochastic conditional duration models]
